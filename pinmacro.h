 ...
 * 
 * Описание:
 * (0) Указание буквы порта, номера вывода и "выключенное состояние". В данном случае диод подключен катодом к выводу
 * (1) Указание буквы порта, номера вывода и "выключенное состояние". В данном случае кнопка подтянута к питанию с включается коммутацией на землю
